...
exports.example1_Einstein = example1_Einstein;
exports.example2_Scientists = example2_Scientists;
exports.example3_Search = example3_Search;
exports.example4_TopAgents = example4_TopAgents;
exports.example5_Stats = example5_Stats;
exports.example6_Era = example6_Era;
exports.example7_Orchestrator = example7_Orchestrator;
const agents_1 = require("./agents");
// Exemplu 1: Găsește și folosește un agent specific
function example1_Einstein() {
    console.log("=== Exemplu 1: Albert Einstein ===");
    const einstein = (0, agents_1.getAgentById)("hart-010-albert-einstein");
    if (einstein) {
        ...
        const systemPrompt = (0, agents_1.getSystemPromptById)(einstein.id);
...
function example3_Search() {
    ...
    const napoleon = (0, agents_1.searchAgentsByName)("Napoleon");
...
function example6_Era() {
    ...
    const ancientAgents = (0, agents_1.listAgentsByEra)("ancient");
...
function example7_Orchestrator() {
    ...
    const scientists = (0, agents_1.listAgentsByDomain)("science");
    const engineers = (0, agents_1.listAgentsByDomain)("technology");
    const candidates = [...scientists, ...engineers];
    const bestAgent = candidates[0]; // Simplificat - în realitate ar folosi scoring
    if (bestAgent) {
        const systemPrompt = (0, agents_1.getSystemPromptById)(bestAgent.id);
